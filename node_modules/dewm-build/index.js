...
var build = {xml:{},html:{},touts:{},elements:{},image:{},menu:{}};
...
build.xml.path = function(week,output,date,stack) {
	if (stack.stack.indexOf("7000") == 0 || stack.stack.indexOf("0100") == 0) { var filename = date+"gofr_GOAT_front.xml"; }
...
build.xml.transform = function(stack,xml,type,output,htmlfile,callback) {
	if (stack.indexOf("0100_") == 0) { var transform = build.menu.toc; }
