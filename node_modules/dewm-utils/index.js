...
utils.format.date.split = function(date) {
	return {y:date.slice(0,2),m:date.slice(2,4),d:date.slice(4,6)};
};
...
utils.find = function(list,q) {
	for (var i=0; i<list.length; i++) { if (list[i].indexOf(q)>-1) { return i; } };
};
