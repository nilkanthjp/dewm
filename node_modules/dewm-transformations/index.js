...
transformations.toc.body = function(toc) {
	...
	.replace(new RegExp("<!--insert year here-->", 'g'), toc.date)
...
transformations.toc.router = function(stack) {
	var routes = {
		"cover":transformations.toc.cover,
		"dept":transformations.toc.dept,
		"fiction":transformations.toc.fiction,
		"crit":transformations.toc.crit,
		"poem":transformations.toc.poem,
		"shouts":transformations.toc.shouts,
	}, section = stack.split("_")[1];
	if (routes[section]===undefined) { return transformations.toc.none; }
	else { return routes[section]; }
};

transformations.toc.none = function(xml,toc) {
	return toc;
};

transformations.toc.cover = function(xml,toc) {
	toc.cover = templates.toc.cover.replace(new RegExp("<!--insert stackname here-->", 'g'), xml.stackname)
	...
	.replace(new RegExp("<!--insert multimedia here-->", 'g'), "");
	return toc;
};

transformations.toc.dept = function(xml,toc) {
	toc.dept += templates.toc.dept.replace(new RegExp("<!--insert stackname here-->", 'g'), xml.stackname)
	.replace(new RegExp("Rubric TK", 'g'), xml.subhead)
	.replace(new RegExp("Author TK", 'g'), xml.author)
	.replace(new RegExp("Title TK", 'g'), xml.title)
	.replace(new RegExp("<!--insert multimedia here-->", 'g'), "");
...
transformations.toc.shouts = function(xml,toc) {
	toc.dept += templates.toc.shouts.replace(new RegExp("<!--insert stackname here-->", 'g'), xml.stackname)
	.replace(new RegExp("Rubric TK", 'g'), xml.subhead)
	.replace(new RegExp("Author TK", 'g'), xml.author)
	.replace(new RegExp("Title TK", 'g'), xml.title)
	.replace(new RegExp("<!--insert multimedia here-->", 'g'), "");
...
transformations.toc.poem = function(xml,toc) {
	toc.dept += templates.toc.poem.replace(new RegExp("<!--insert stackname here-->", 'g'), xml.stackname)
	.replace(new RegExp("Rubric TK", 'g'), xml.subhead)
	.replace(new RegExp("Author TK", 'g'), xml.author)
	.replace(new RegExp("Title TK", 'g'), xml.title)
	.replace(new RegExp("<!--insert multimedia here-->", 'g'), "");
...
transformations.toc.crit = function(xml,toc) {
	toc.crit += templates.toc.dept.replace(new RegExp("<!--insert stackname here-->", 'g'), xml.stackname)
	.replace(new RegExp("Rubric TK", 'g'), xml.subhead)
	.replace(new RegExp("Author TK", 'g'), xml.author)
	.replace(new RegExp("Title TK", 'g'), xml.title)
	.replace(new RegExp("<!--insert multimedia here-->", 'g'), "");
